...
class _UpdateServiceRequestScreenState extends State<UpdateServiceRequestScreen> {
  ...
  Future<ServiceRequest> _loadServiceRequestData() async {
    ...
    if(mounted) {
      ...
      selectedValue = clientList.where((element) => serviceRequestProvider.serviceModel!.clientId == element.clientId).first.clientId;
        ...
        children: [
          ...
          Flexible(
            child: Container(
              ...
              child: serviceRequestProvider.serviceModel == null || clientProvider.clientsModel == null
                ? Center(
                ...
                children: [
                  ...
                  ButtonWidgetSolid(
                    label: "Guardar",
                    onTap: () async {
                      bool response = await serviceRequestProvider.updateServiceRequest(
                          ServiceRequest(
                              requestId: widget.serviceId,
                              clientId: serviceRequestProvider.serviceModel!.clientId,
                              description: _descriptionController.text,
                              requestDate: serviceRequestProvider.serviceModel!.requestDate,
                              state: ServiceRequest.parseServiceRequestStateToString(selectedValueState)
                          )
                      );
