...
class _UpdateEmployeeScreenState extends State<UpdateEmployeeScreen> {
  ...
  Future<Employee> _loadEmployeeData() async {
    ...
    if (mounted) {
      ...
      _nameController =
          TextEditingController(text: employeeProvider.employeeModel?.name);
      _positionController =
          TextEditingController(text: employeeProvider.employeeModel?.position);
      _phoneController =
          TextEditingController(text: employeeProvider.employeeModel?.phone);
                        ...
                        children: [
                          ...
                          Container(
                            child: ButtonWidgetSolid(
                              label: "Guardar",
                              onTap: () async {
                                bool response = await employeeProvider
                                    .updateEmployee(Employee(
                                        ...
                                        state:
                                            Employee.parseEmployeeStateToString(
                                                selectedValue)));
