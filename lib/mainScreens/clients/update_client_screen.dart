...
class _UpdateClientScreenState extends State<UpdateClientScreen> {
  ...
  late TextEditingController _identificationController = TextEditingController();
  ...
  Future<void> _loadClientData() async {
    ...
    if (mounted) {
      _identificationController = TextEditingController(text: clientProvider.clientModel?.cedula);
      _nameController = TextEditingController(text: clientProvider.clientModel?.name);
      _addressController = TextEditingController(text: clientProvider.clientModel?.address);
      _phoneController = TextEditingController(text: clientProvider.clientModel?.phone);
      _emailController = TextEditingController(text: clientProvider.clientModel?.email);
